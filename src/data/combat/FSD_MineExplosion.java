...
public class FSD_MineExplosion implements ProximityExplosionEffect {
...
//	}
public static NEParams copyNEParams(NEParams params) {
    NEParams copy = new NEParams();
    copy.radius = params.radius;
    copy.withHitGlow = params.withHitGlow;
    return copy;
}
    public static void spawnStandardRift(DamagingProjectileAPI explosion, NEParams params) {
        ...
        for (int i = 0; i < 2; i++) {
            NEParams p = copyNEParams(params);
    ...
    public static NEParams createStandardRiftParams(String minelayerId, float baseRadius) {
        Color color = new Color(212,8,57,255);
