...
public class FSD_LSRpart implements EveryFrameWeaponEffectPlugin {
    ...
    public void advance(float amount, CombatEngineAPI engine, WeaponAPI weapon) {
        ...
        if (ship != null) {
            if(weapon.getSpec().getWeaponId().equals("FSD_LSRpart1")){
            ...
            if(weapon.getSpec().getWeaponId().equals("FSD_LSRpart2")){
            ...
            if(weapon.getSpec().getWeaponId().equals("FSD_LSRpart3")){
