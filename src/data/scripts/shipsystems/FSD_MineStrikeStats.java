...
public class FSD_MineStrikeStats extends BaseShipSystemScript implements MineStrikeStatsAIInfoProvider {
    ...
    public static final Color JITTER_COLOR = new Color(163, 86, 91, 189);
    public static final Color JITTER_UNDER_COLOR = new Color(163, 86, 91, 189);
    public static final String WEAPON_ID = "FSD_minelayer2";
